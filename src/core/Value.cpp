...
bool Value::operator == ( const Value &other ) const
{
    ...
    else
    {
        static UnorderedMap<u32, bool(*)(const Value&, const Value&)> equalFuncs
        {
                ...
                { MakeValueType( ValueType::String , StringType::Long ) , []( const Value& a , const Value& b ) { return a.s->Compare(*b.s )==0; } },
                { MakeValueType( ValueType::String , StringType::Short ) , []( const Value& a , const Value& b ) { return a.s->Compare(*b.s )==0; } },
